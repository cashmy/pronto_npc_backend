...
from character_group.models import CharacterGroup  # Import CharacterGroup
...
class CharacterSubGroupSerializer(serializers.ModelSerializer):
    ...
    # Use SlugRelatedField for the character_group relationship.
    # On write (POST/PUT), it expects the 'character_group_name'.
    # On read (GET), it will output the 'character_group_name'.
    character_group = serializers.SlugRelatedField(
        slug_field="character_group_name", queryset=CharacterGroup.objects.all()
    )
    ...
    class Meta:
        ...
        fields = [
            "id",  # Keep the ID for the sub-group itself
